...
public class ImageFrag17 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, 
		...
		View v=inflater.inflate(R.layout.imagefrag17, container, false);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
		...
		case R.id.action_wall:
		{
			...
			ImageTask17 it1=new ImageTask17(getActivity());
			it1.execute();
...
class ImageTask17 extends AsyncTask<Void, Void, Void>
{

	Context c;
	ProgressDialog pd;
	
	public ImageTask17(Context ctx)
	{
		this.c=ctx;
	}
	@Override
	...
	protected Void doInBackground(Void... params) {
		...
		try {
			wm1.setBitmap(ImageFrag17.bmg1);
		} catch (IOException e) {
