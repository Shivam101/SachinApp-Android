...
public class ImageFrag7 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, 
		...
		View v=inflater.inflate(R.layout.imagefrag7, container, false);
	 ...
	 public void onCreateOptionsMenu(Menu menu,MenuInflater inflater) {
	    ...
	    public boolean onOptionsItemSelected(MenuItem item) {
			...
			case R.id.action_wall:
			{
				...
				ImageTask7 it1=new ImageTask7(getActivity());
				it1.execute();
...
class ImageTask7 extends AsyncTask<Void, Void, Void>
{

	Context c;
	ProgressDialog pd;
	
	public ImageTask7(Context ctx)
	{
		this.c=ctx;
	}
	@Override
