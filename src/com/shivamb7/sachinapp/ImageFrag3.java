...
public class ImageFrag3 extends Fragment {
   static ImageView iv1;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, 
    	...
    	View v=inflater.inflate(R.layout.imagefrag3, container, false);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
		...
		case R.id.action_wall:
		{
			...
			ImageTask3 it1=new ImageTask3(getActivity());
			it1.execute();
...
class ImageTask3 extends AsyncTask<Void, Void, Void>
{

	Context c;
	ProgressDialog pd;
	
	public ImageTask3(Context ctx)
	{
		this.c=ctx;
	}
	@Override
