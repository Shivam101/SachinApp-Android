...
public class ImageFrag8 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, 
		...
		View v=inflater.inflate(R.layout.imagefrag8, container, false);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
		...
		case R.id.action_wall:
		{
			...
			ImageTask8 it1=new ImageTask8(getActivity());
			it1.execute();
...
class ImageTask8 extends AsyncTask<Void, Void, Void>
{

	Context c;
	ProgressDialog pd;
	
	public ImageTask8(Context ctx)
	{
		this.c=ctx;
	}
	@Override
