...
public class ImageFrag13 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, 
		...
		View v=inflater.inflate(R.layout.imagefrag13, container, false);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
		...
		case R.id.action_wall:
		{
			...
			ImageTask13 it1=new ImageTask13(getActivity());
			it1.execute();
...
class ImageTask13 extends AsyncTask<Void, Void, Void>
{

	Context c;
	ProgressDialog pd;
	
	public ImageTask13(Context ctx)
	{
		this.c=ctx;
	}
	@Override
	...
	protected Void doInBackground(Void... params) {
		...
		try {
			wm1.setBitmap(ImageFrag13.bmg1);
		} catch (IOException e) {
