...
public class ImageFrag4 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, 
    	...
    	View v=inflater.inflate(R.layout.imagefrag4, container, false);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
		...
		case R.id.action_wall:
		{
			...
			ImageTask4 it1=new ImageTask4(getActivity());
			it1.execute();
...
class ImageTask4 extends AsyncTask<Void, Void, Void>
{

	Context c;
	ProgressDialog pd;
	
	public ImageTask4(Context ctx)
	{
		this.c=ctx;
	}
	@Override
