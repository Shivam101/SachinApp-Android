...
public class ImageFrag16 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, 
		...
		View v=inflater.inflate(R.layout.imagefrag16, container, false);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
		...
		case R.id.action_wall:
		{
			...
			ImageTask16 it1=new ImageTask16(getActivity());
			it1.execute();
...
class ImageTask16 extends AsyncTask<Void, Void, Void>
{

	Context c;
	ProgressDialog pd;
	
	public ImageTask16(Context ctx)
	{
		this.c=ctx;
	}
	@Override
	...
	protected Void doInBackground(Void... params) {
		...
		try {
			wm1.setBitmap(ImageFrag16.bmg1);
		} catch (IOException e) {
