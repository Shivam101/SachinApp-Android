...
public class ImageFrag5 extends Fragment {
   static ImageView iv1;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, 
		...
		View v=inflater.inflate(R.layout.imagefrag5, container, false);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
		...
		case R.id.action_wall:
		{
			...
			ImageTask5 it1=new ImageTask5(getActivity());
			it1.execute();
...
class ImageTask5 extends AsyncTask<Void, Void, Void>
{

	Context c;
	ProgressDialog pd;
	
	public ImageTask5(Context ctx)
	{
		this.c=ctx;
	}
	@Override
