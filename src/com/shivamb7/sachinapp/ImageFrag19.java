...
public class ImageFrag19 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, 
		...
		View v=inflater.inflate(R.layout.imagefrag19, container, false);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
		...
		/*	WallpaperManager wm=WallpaperManager.getInstance(getActivity().getApplicationContext());
			...
			ImageTask19 it1=new ImageTask19(getActivity());
			it1.execute();
...
class ImageTask19 extends AsyncTask<Void, Void, Void>
{

	Context c;
	ProgressDialog pd;
	
	public ImageTask19(Context ctx)
	{
		this.c=ctx;
	}
	@Override
	...
	protected Void doInBackground(Void... params) {
		...
		try {
			wm1.setBitmap(ImageFrag19.bmg1);
		} catch (IOException e) {
