...
public class ImageFrag15 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, 
		...
		View v=inflater.inflate(R.layout.imagefrag15, container, false);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
		...
		case R.id.action_wall:
		{
			...
			ImageTask15 it1=new ImageTask15(getActivity());
			it1.execute();
...
class ImageTask15 extends AsyncTask<Void, Void, Void>
{

	Context c;
	ProgressDialog pd;
	
	public ImageTask15(Context ctx)
	{
		this.c=ctx;
	}
	@Override
	...
	protected Void doInBackground(Void... params) {
		...
		try {
			wm1.setBitmap(ImageFrag15.bmg1);
		} catch (IOException e) {
