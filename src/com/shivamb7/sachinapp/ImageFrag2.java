...
public class ImageFrag2 extends Fragment {
   ...
   @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, 
    	...
    	View v=inflater.inflate(R.layout.imagefrag2, container, false);
   ...
   public boolean onOptionsItemSelected(MenuItem item) {
		...
		/*	WallpaperManager wm=WallpaperManager.getInstance(getActivity().getApplicationContext());
			...
			ImageTask2 it1=new ImageTask2(getActivity());
			it1.execute();
...
class ImageTask2 extends AsyncTask<Void, Void, Void>
{

	Context c;
	ProgressDialog pd;
	
	public ImageTask2(Context ctx)
	{
		this.c=ctx;
	}
	@Override
