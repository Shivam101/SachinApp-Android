...
public class ImageFrag9 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, 
		...
		View v=inflater.inflate(R.layout.imagefrag9, container, false);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
		...
		case R.id.action_wall:
		{
			...
			ImageTask9 it1=new ImageTask9(getActivity());
			it1.execute();
...
class ImageTask9 extends AsyncTask<Void, Void, Void>
{

	Context c;
	ProgressDialog pd;
	
	public ImageTask9(Context ctx)
	{
		this.c=ctx;
	}
	@Override
