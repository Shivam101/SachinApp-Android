...
public class ImageFrag11 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, 
		...
		View v=inflater.inflate(R.layout.imagefrag11, container, false);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
		...
		/*	WallpaperManager wm=WallpaperManager.getInstance(getActivity().getApplicationContext());
			...
			ImageTask11 it1=new ImageTask11(getActivity());
			it1.execute();
    ...
    class ImageTask11 extends AsyncTask<Void, Void, Void>
    {

    	Context c;
    	ProgressDialog pd;
    	
    	public ImageTask11(Context ctx)
    	{
    		this.c=ctx;
    	}
    	@Override
    	...
    	protected Void doInBackground(Void... params) {
    		...
    		try {
    			wm1.setBitmap(ImageFrag11.bmg1);
    		} catch (IOException e) {
